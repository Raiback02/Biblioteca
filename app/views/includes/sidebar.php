<div class="d-flex">
    <div class="bg-dark text-white vh-100 p-3" style="width: 250px;">
        ...
        <ul class="nav flex-column">
            ...
            <?php else: ?>
                <li class="nav-item"><a href="#" class="nav-link text-white"><i class="bi bi-book-half"></i> Consultar Livros</a></li>
                <li class="nav-item"><a href="#" class="nav-link text-white"><i class="bi bi-bookmark"></i> Minhas Reservas</a></li>
            <?php endif; ?>
        </ul>
    </div>
